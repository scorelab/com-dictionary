...
import { createNewUser, addNewUser } from "../../store/actions";
...
const RegistrationForm = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      await createNewUser(email, password, username)(firebase, history);
      // await addNewUser(email, password, username)(firestore);
    } catch (e) {
      console.log(e);
    }
  };
